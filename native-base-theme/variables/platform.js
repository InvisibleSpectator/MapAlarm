...
export default {
  ...
  // Color
  brandPrimary: platform === PLATFORM.IOS ? '#32505C' : '#32505C',
  brandInfo: '#74a3b5',
  brandSuccess: '#5cb85c',
  brandDanger: '#d9534f',
  brandWarning: '#f0ad4e',
  ...
  // Footer
  footerHeight: 55,
  footerDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : '#32505C',
  footerPaddingBottom: 0,

  // FooterTab
  tabBarTextColor: platform === PLATFORM.IOS ? '#6b6b6b' : '#b3c7f9',
  tabBarTextSize: platform === PLATFORM.IOS ? 14 : 11,
  activeTab: platform === PLATFORM.IOS ? '#32505C' : '#fff',
  sTabBarActiveTextColor: '#32505C',
  tabBarActiveTextColor: platform === PLATFORM.IOS ? '#32505C' : '#fff',
  tabActiveBgColor: platform === PLATFORM.IOS ? '#cde1f9' : '#32505C',

  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? '#32505C' : '#fff',
  toolbarDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : '#32505C',
  toolbarHeight: platform === PLATFORM.IOS ? 64 : 56,
  toolbarSearchIconSize: platform === PLATFORM.IOS ? 20 : 23,
  toolbarInputColor: platform === PLATFORM.IOS ? '#CECDD2' : '#fff',
  searchBarHeight: platform === PLATFORM.IOS ? 30 : 40,
  searchBarInputHeight: platform === PLATFORM.IOS ? 30 : 50,
  toolbarBtnTextColor: platform === PLATFORM.IOS ? '#32505C' : '#fff',
  toolbarDefaultBorder: platform === PLATFORM.IOS ? '#a7a6ab' : '#32505C',
  ...
  listItemSelected: platform === PLATFORM.IOS ? '#32505C' : '#32505C',
  ...
  radioSelectedColorAndroid: '#32505C',
  ...
  // Segment
  segmentBackgroundColor: platform === PLATFORM.IOS ? '#F8F8F8' : '#32505C',
  segmentActiveBackgroundColor: platform === PLATFORM.IOS ? '#32505C' : '#fff',
  segmentTextColor: platform === PLATFORM.IOS ? '#32505C' : '#fff',
  segmentActiveTextColor: platform === PLATFORM.IOS ? '#fff' : '#32505C',
  segmentBorderColor: platform === PLATFORM.IOS ? '#32505C' : '#fff',
  segmentBorderColorMain: platform === PLATFORM.IOS ? '#a7a6ab' : '#32505C',
  ...
  tabDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : '#32505C',
  topTabBarTextColor: platform === PLATFORM.IOS ? '#6b6b6b' : '#b3c7f9',
  topTabBarActiveTextColor: platform === PLATFORM.IOS ? '#32505C' : '#fff',
  topTabBarBorderColor: platform === PLATFORM.IOS ? '#a7a6ab' : '#fff',
  topTabBarActiveBorderColor: platform === PLATFORM.IOS ? '#32505C' : '#fff',
